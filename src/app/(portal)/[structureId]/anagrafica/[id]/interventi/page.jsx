...
import { InterventionManager } from "@/components/group-home/InterventionManager";
import { Button } from "@/components/ui/button";

export default async function InterventiPage({ params }) {
  ...
  try {
    const [anagrafica, entries] = await Promise.all([
      ...
      listInterventions(structureId, anagraficaId),
    ]);
